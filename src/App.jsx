  ...
  return (
    <>
      ...
      <div className="main-cont">
        <Header showDelModal={showDelModal} handleDeleteDoc={handleDeleteDoc} title={title} handleLeftMenu={handleLeftMenu} handleSaveDoc={handleSaveDoc} handleTitleChange={handleTitleChange} />
        <DeleteDialog deleteDialogRef={deleteDialogRef} handleDeleteDoc={handleDeleteDoc} />
        <div className="text-contents">
          <div className="left-area">
            <UserInputArea rawInput={rawInput} inputRef={inputRef} handleChange={handleChange} input={input} isEditing={isEditing} />
          </div>
...
function Header({ showDelModal, handleDeleteDoc, title, handleLeftMenu, handleSaveDoc, handleTitleChange }) {
...
function UserInputArea({ handleChange, input, inputRef, isEditing, rawInput }) {
