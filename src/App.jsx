    ...
    <MarkdownContext.Provider value={contextValue}>
      ...
      <div className="main-cont">
        ...
        <div className="text-contents">
          {(
            <div className={!visible ? "nodisplay left-area area" : "left-area area"}>
              <div className="markdown-title gray-title">
                <p>MARKDOWN</p>
                <button onClick={handleVisibility} className={visible ? 'eye-btn' : 'nodisplay-desktop eye-btn'}>
          ...
          <div className={visible ? "nodisplay right-area area" : "right-area area"}>
